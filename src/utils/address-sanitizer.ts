...
import { BucharestSectors, type BucharestSector, type RomanianCountyCode } from './codes';
 ...
 */
export function sanitizeBucharestSector(city: string): BucharestSector | string {
